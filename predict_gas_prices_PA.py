...
if __name__=="__main__":
    ...
    path=r"C:\Users\Arne\Documents\DataScience\python\Python_Markus\gas_prices/" #path of the project
    ...
    result=start_process(processdata[1])###multiprocessing of the predictions.
    ###just use one to test the whole thing
    ...
    #no uplload....just playing around with some features
